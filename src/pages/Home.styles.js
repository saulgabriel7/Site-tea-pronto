...
.popup {
  ...
  .popup ul li:before {
    ...
    margin-right: 8px;
    color: #A4D1E6; /* Cor do ponto */
  }

  /* Estilos para telas menores (ajustes no mobile) */
  @media (max-width: 768px) {
    .popup {
      width: 90%; /* O pop-up ocupa 90% da largura da tela no mobile */
      right: 5%;
      top: 60px;
    }
  }
...
export const ExplicacaoContainer = styled.div`
    ...
    @media (max-width: 800px) {
        .explicacao-1{
            padding-top: 0px;
            display: flex;
            flex-direction: column-reverse; /* Move images above text */
            align-items: center;
            padding-inline: 35px;
        }
